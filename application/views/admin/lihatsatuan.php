				...
				<thead>
					...
					<tr>
						...
						<td class="align-middle text-center">       
							<a href="<?php echo site_url('lihatsatuan/edit/'.$f['Id_satuan']) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-pencil">Edit</span></a>
						</td>
						<td class="align-middle text-center">          
							<a onclick="deleteConfirm('<?php echo site_url('lihatsatuan/hapus/'.$f['Id_satuan']) ?>')" href="#!" class="btn btn-primary"><span class="glyphicon glyphicon-trash">Hapus</a>        
						</td> 						
					</tr>
				<?php } ?>
			</table>
