...
<html>
    <head>
        ...
        <title>Pesanan Kiloan Datang | Admin</title>
...
<script src="<?php echo base_url('assets/js/bootstrap.min.js') ?>"></script>
    ...
    <body>
		...
		<h3>Daftar Pesanan Kiloan - Langsung</h3>
				...
				<thead>
					...
					<tr>
						...
						<td class="align-middle text-center">       
							<a href="<?php echo site_url('lihatkiloan/editdatang/'.$f['Id_Kiloan']) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-pencil">Edit</span></a>
						</td>
						<td class="align-middle text-center">          
							<a onclick="deleteConfirm('<?php echo site_url('lihatkiloan/hapusdatang/'.$f['Id_Kiloan']) ?>')" href="#!" class="btn btn-primary"><span class="glyphicon glyphicon-trash">Hapus</a>        
						</td> 						
					</tr>
				<?php } ?>
			</table>
