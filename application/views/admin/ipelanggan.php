...
<html>
    ...
    <script src="<?php echo base_url("assets/js/configpelanggan.js"); ?>"></script> <!-- Load file process.js -->
...
<div id="view">
  <?php $this->load->view('admin/pelanggan', array('pelanggan'=>$pelanggan)); // Load file view.php dan kirim data siswanya ?>
</div>
